...
200 SIZE = 7: CURX = 1: CURY = 1: SCX = 4: SCY = 4: WON = 0: DIM BOARD(SIZE, SIZE)
990 GOTO 22000
...
31120 IF DT THEN GOSUB 12000: GOSUB 14100: IF WON = 1 THEN GOTO 21000: REM Toggle candle, check winning and show win screen
