...
12011 IF BOARD(CURX, CURY) = 1 THEN BOARDON = BOARDON + 1: GOTO 12020
12012 BOARDON = BOARDON - 1
12020 IF SCX < SIZE THEN BOARD(CURX + 1, CURY) = ABS(BOARD(CURX + 1, CURY) - 1): GOTO 12022
12021 GOTO 12030
12022 IF BOARD(CURX + 1, CURY) = 1 THEN BOARDON = BOARDON + 1: GOTO 12030
12023 BOARDON = BOARDON - 1
12030 IF SCX > 1 THEN BOARD(CURX - 1, CURY) = ABS(BOARD(CURX - 1, CURY) - 1): GOTO 12032
12031 GOTO 12040
12032 IF BOARD(CURX -1, CURY) = 1 THEN BOARDON = BOARDON + 1: GOTO 12040
12033 BOARDON = BOARDON - 1
12040 IF SCY < SIZE THEN BOARD(CURX, CURY + 1) = ABS(BOARD(CURX, CURY + 1) - 1): GOTO 12042
12041 GOTO 12050
12042 IF BOARD(CURX, CURY + 1) = 1 THEN BOARDON = BOARDON + 1: GOTO 12050
12043 BOARDON = BOARDON - 1
12050 IF SCY > 1 THEN BOARD(CURX, CURY - 1) = ABS(BOARD(CURX, CURY - 1) - 1): GOTO 12052
12051 GOTO 12060
12052 IF BOARD(CURX, CURY - 1) = 1 THEN BOARDON = BOARDON + 1: GOTO 12060
12053 BOARDON = BOARDON - 1
12060 RETURN


12100 GOSUB 10000: REM Update candles surrounding current
...
13021 FOR X=0 TO 1: CURX = INT(SIZE * RND(0)) + 1: SCX = CURX: CURY = INT(SIZE * RND(0)) + 1: SCY = CURY: GOSUB 12000: NEXT X
