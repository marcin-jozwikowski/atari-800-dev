...
13010 FOR Y=1 TO SIZE: FOR X=1 TO SIZE: BOARD(X, Y) = 1: NEXT X: NEXT Y
...
13030 CURX = 1: CURY = 1: SCX = 4: SCY = 4
13100 RETURN

14100 REM Check game finished
14110 WON = 1
14120 FOR Y=1 TO SIZE: FOR X=1 TO SIZE
14130 IF BOARD(X, Y) = 0 THEN WON = 0: RETURN
14140 NEXT X: NEXT Y
14150 RETURN
